...
> Film demo mode first (no keys): `MH_DEMO_MODE=true` on the orchestrator and
> Demo mode ON in the control center. Live TrueForge is optional and labeled
> separately; demo never claims GitHub writes or Daytona.
